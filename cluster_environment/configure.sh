...
STRUCTURE_INPUT_DIR="${STRUCTURE_INPUT_DIR:-${SYMMCD_ROOT}/input_structures}"
ENERGY_OUTPUT_ROOT="${ENERGY_OUTPUT_ROOT:-${SYMMCD_ROOT}/calculation_results/mace_energy}"
VASP_CMD="${VASP_CMD:-}"
...
mkdir -p "${BAND_OUTPUT_ROOT}" "${STRUCTURE_INPUT_DIR}" "${ENERGY_OUTPUT_ROOT}"
...
export STRUCTURE_INPUT_DIR="${STRUCTURE_INPUT_DIR}"
export ENERGY_OUTPUT_ROOT="${ENERGY_OUTPUT_ROOT}"
...
ENERGY_OUTPUT_ROOT=${ENERGY_OUTPUT_ROOT}
